...
InputDecoration buildSHInputDecoration(String name, {Widget? prefixIcon, Widget? suffixIcon, Color? textColor,}) {
  return InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(16.0), borderSide: const BorderSide(color: grey, width: 0.5)),
  ...
  return Container(
    ...
    child: Row(
      children: [
        ...
        const Icon(Icons.arrow_drop_down, color: tomato),
      ],
    ),
  );
}
